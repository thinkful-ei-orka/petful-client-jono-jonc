  ...
  render() {
    ...
    return (
      <div className='cat-display'>
        ...
        <p>
          <strong>Name:</strong> {this.state.cat.name}
        </p>
        <p>
          <strong>Gender:</strong> {this.state.cat.gender}
        </p>
        <p>
          <strong>Age:</strong> {this.state.cat.age} yrs
        </p>
        <p>
          <strong>Breed:</strong> {this.state.cat.breed}
        </p>
        <p>
          <strong>Fluffy's story:</strong> {this.state.cat.story}
        </p>
